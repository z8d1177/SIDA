function [object,grad] = computeObjectAndGradiend(theta, numM, numK, numC, numX, beta, gamma, traindata, testdata, trainlabel)
   ...
   object = J1 + beta * J2 + gamma * J3;
    ...
    W1grad = W1grad3 + beta * W1grad2 +  2 * gamma * W1;   
    b1grad = b1grad3 + beta * b1grad2 +  2 * gamma * b1; 
    ...
    W2grad = beta * W2grad2 +  2 * gamma * W2;   
    b2grad = beta * b2grad2 +  2 * gamma * b2; 
